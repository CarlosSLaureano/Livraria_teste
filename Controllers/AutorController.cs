...
public class AutorController : Controller
{
    ...
    public async Task<ActionResult<ResponseModel<AutorModel>>> BuscarAutorePorId(int idAutor)
    {
    ...
    public async Task<ActionResult<ResponseModel<LivroModel>>> BuscarAutorPorIdLivro(int idLivro)
    {
